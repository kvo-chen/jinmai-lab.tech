...
export default function CulturalNews() {
  ...
  const newsItems: NewsItem[] = [
    ...
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=National%20cultural%20heritage%20administration%20digital%20protection%20guidelines',
      date: '2025-10-25',
      category: '政策动态',
      source: '国家文物局',
      views: 14567
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=National%20level%20cultural%20industry%20demonstration%20park%20review%20results',
      date: '2025-10-18',
      category: '政策动态',
      source: '文化和旅游部',
      views: 11234
    ...
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=National%20youth%20cultural%20creative%20competition%20final%20Shenzhen',
      date: '2025-11-15',
      category: '赛事活动',
      source: '中国青少年发展基金会',
      views: 9876
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=2025%20China%20traditional%20craft%20skills%20competition',
      date: '2025-12-10',
      category: '赛事活动',
      source: '中国工艺美术协会',
      views: 7654
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=First%20Guochao%20Star%20design%20competition%20registration%20launch',
      date: '2025-11-30',
      category: '赛事活动',
      source: '中国时尚协会',
      views: 8921
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=2025%20China%20digital%20cultural%20creative%20competition%20results',
      date: '2025-11-25',
      category: '赛事活动',
      source: '中国数字文化产业协会',
      views: 10345
    ...
    // 展览展示
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=First%20China%20traditional%20color%20art%20exhibition%20Shanghai%20opening',
      date: '2025-11-25',
      category: '展览展示',
      source: '上海文化艺术报',
      views: 9876
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=Silk%20Road%20splendor%20ancient%20silk%20art%20exhibition%20National%20Museum',
      date: '2025-12-01',
      category: '展览展示',
      source: '中国国家博物馆',
      views: 14567
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=China%20traditional%20furniture%20art%20exhibition%20Forbidden%20City',
      date: '2025-11-15',
      category: '展览展示',
      source: '故宫博物院',
      views: 16789
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=Ink%20charm%20of%20China%20contemporary%20calligraphy%20art%20exhibition%20Beijing',
      date: '2025-11-10',
      category: '展览展示',
      source: '中国书法家协会',
      views: 8921
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=China%20traditional%20ceramic%20art%20exhibition%20Jingdezhen',
      date: '2025-10-28',
      category: '展览展示',
      source: '景德镇陶瓷大学',
      views: 11234
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=China%20traditional%20toys%20exhibition%20Guangzhou',
      date: '2025-10-20',
      category: '展览展示',
      source: '广东省博物馆',
      views: 7654
    ...
    // 技术应用
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=Digital%20technology%20aiding%20intangible%20cultural%20heritage%20transmission',
      date: '2025-11-20',
      category: '技术应用',
      source: '科技日报',
      views: 11234
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=AI%20technology%20empowering%20traditional%20painting%20creation',
      date: '2025-11-15',
      category: '技术应用',
      source: '中国艺术研究院',
      views: 9876
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=Blockchain%20technology%20application%20in%20cultural%20heritage%20protection',
      date: '2025-11-10',
      category: '技术应用',
      source: '中国文物保护技术协会',
      views: 13456
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=5G%20AR%20technology%20creating%20immersive%20cultural%20experience',
      date: '2025-10-28',
      category: '技术应用',
      source: '中国文化报',
      views: 15678
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=Digital%20twin%20technology%20application%20in%20ancient%20architecture%20protection',
      date: '2025-10-20',
      category: '技术应用',
      source: '中国建筑学会',
      views: 10345
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=Big%20data%20technology%20application%20in%20cultural%20industry',
      date: '2025-10-15',
      category: '技术应用',
      source: '中国信息协会',
      views: 12345
    ...
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=Forbidden%20City%20cultural%20and%20creative%20Cat%20series%20new%20products',
      date: '2025-12-01',
      category: '品牌动态',
      source: '故宫博物院',
      views: 14567
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=China%20Li-Ning%202026%20spring%20summer%20collection%20release',
      date: '2025-11-25',
      category: '品牌动态',
      source: '李宁官方',
      views: 18923
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=Daoxiangcun%20intangible%20cultural%20heritage%20skill%20series%20pastries',
      date: '2025-11-20',
      category: '品牌动态',
      source: '稻香村官方',
      views: 9876
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=Moutai%20Cultural%20Moutai%20series%20alcohol%20products',
      date: '2025-11-15',
      category: '品牌动态',
      source: '茅台集团',
      views: 16789
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=Zhang%20Xiaoquan%20new%20brand%20image%20release',
      date: '2025-11-10',
      category: '品牌动态',
      source: '张小泉官方',
      views: 8921
    ...
    // 市场动态
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=Guochao%20design%20becoming%20new%20favorite%20among%20young%20consumers',
      date: '2025-11-10',
      category: '市场动态',
      source: '消费日报',
      views: 13456
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=2025%20first%20three%20quarters%20cultural%20industry%20added%20value%20growth',
      date: '2025-10-28',
      category: '市场动态',
      source: '国家统计局',
      views: 15678
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=Digital%20cultural%20industry%20scale%20exceeds%205%20trillion%20yuan',
      date: '2025-10-20',
      category: '市场动态',
      source: '中国数字文化产业协会',
      views: 17892
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=Traditional%20culture%20theme%20scenic%20spots%20visitor%20volume%20growth',
      date: '2025-10-15',
      category: '市场动态',
      source: '中国旅游协会',
      views: 11234
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=Cultural%20and%20creative%20products%20market%20scale%20continues%20to%20expand',
      date: '2025-10-10',
      category: '市场动态',
      source: '中国文化创意产业研究会',
      views: 9876
    },
    {
      ...
      image: '/api/proxy/trae-api/api/ide/v1/text_to_image?image_size=landscape_4_3&prompt=Traditional%20culture%20books%20sales%20growth',
      date: '2025-09-28',
      category: '市场动态',
      source: '中国出版协会',
      views: 8921
