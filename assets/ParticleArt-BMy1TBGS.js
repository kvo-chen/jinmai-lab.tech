import{r as i,j as l}from"./index-DbdEsYEp.js";function p(){const t=i.useRef(null);return i.useEffect(()=>{t.current&&(t.current.style.position="relative",t.current.style.width="100%",t.current.style.height="100vh",t.current.style.backgroundColor="#050505",t.current.style.margin="0",t.current.style.overflow="hidden",t.current.style.fontFamily="Segoe UI, sans-serif",t.current.innerHTML=`
        <!-- 加载遮罩层 -->
